...
//                $this->_updateButton('content_button', 'onclick', 'Modalbox.show($(\'feed_content_code\'), {title: \'' . $this->__('Feed # %s: submitted content', $this->getSubmissionId()) . '\', width: (document.viewport.getWidth() - 120)})');
...
//                $this->_updateButton('result_button', 'onclick', 'Modalbox.show($(\'processing_result_code\'), {title: \'' . $this->__('Feed # %s: processing result', $this->getSubmissionId()) . '\', width: (document.viewport.getWidth() - 120)})');
