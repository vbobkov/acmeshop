...
abstract class Creativestyle_CheckoutByAmazon_Block_Abstract extends Mage_Checkout_Block_Onepage_Abstract {
    ...
    const XML_PATH_OVERLAY_ENABLED          = 'checkoutbyamazon/design/overlay_enabled';
    const XML_PATH_OVERLAY_WIDTH            = 'checkoutbyamazon/design/overlay_width';
    ...
    public function isOverlayEnabled() {
        return Mage::getStoreConfig(self::XML_PATH_OVERLAY_ENABLED);
    }

    public function getOverlayWidth() {
        return Mage::getStoreConfig(self::XML_PATH_OVERLAY_WIDTH);
    }
