...
class Creativestyle_CheckoutByAmazon_Helper_Data extends Mage_Core_Helper_Abstract {
    ...
    public function throwException($message, $code = 0, $params = array()) {
        ...
        if (!$this->isExceptionLoggingLocked()) {
            Creativestyle_CheckoutByAmazon_Model_Logger::logException(
                    ...
                    isset($params['orders']) ? $params['orders'] : null
                );
        }
        throw $exception;
    }
    ...
    public function getCheckoutByAmazonButton() {
        return Mage::getSingleton('core/layout')->createBlock('checkoutbyamazon/link')->setTemplate('creativestyle/checkoutbyamazon/shortcut.phtml')->toHtml();
    }
    ...
    public function setAmazonProcessingOrders($orders) {
        Mage::register('amazon_processing_orders', $orders, true);
    }

    public function unsetAmazonProcessingOrders() {
        Mage::unregister('amazon_processing_orders');
    }
