...
class Creativestyle_CheckoutByAmazon_CheckoutController extends Mage_Core_Controller_Front_Action {
    ...
    public function indexAction() {
        ...
        $showInOverlay = $this->getRequest()->getPost('overlay', null);
        if (null === $showInOverlay) $showInOverlay = Mage::getStoreConfig(Creativestyle_CheckoutByAmazon_Block_Abstract::XML_PATH_OVERLAY_ENABLED);
