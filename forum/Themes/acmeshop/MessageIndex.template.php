...
function template_main()
{
	...
	<div class="tborder topic_table" id="messageindex">
		...
		{
			if(
				$topic['first_post']['hiddenOption']
				&& (isset($topic['first_post']['member']) && $context['user']['username'] != $topic['first_post']['member']['username'])
				&& !($context['user']['is_admin'] || $context['user']['is_mod'])
			) {
				continue;
			}
