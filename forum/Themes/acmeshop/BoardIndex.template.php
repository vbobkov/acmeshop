		...
		echo '
			...
			foreach ($category['boards'] as $board)
			{
				...
				if (!empty($board['last_post']['id'])) {
					...
					*/
					echo '
						<p><strong>', $txt['last_post'], '</strong><br />', $board['last_post']['time'],'</p>';
				}
				echo '
					</td>
				</tr>';
...
function template_info_center()
{
	...
	if ($settings['show_stats_index'])
	{
		echo '
			...
			echo $context['common_stats']['total_posts'], ' ', $txt['posts_made'], ' ', $txt['in'], ' ', $context['common_stats']['total_topics'], ' ', $txt['topics'], ' ', $txt['by'], ' ', $context['common_stats']['total_members'], ' ', $txt['members'], '. ';
			// echo !empty($settings['show_latest_member']) ? $txt['latest_member'] . ': <strong> ' . $context['common_stats']['latest_member']['link'] . '</strong>' : '', '<br />';
			if($context['user']['can_mod']) {
				echo $txt['latest_member'] . ': <strong> ' . $context['common_stats']['latest_member']['link'] . '</strong><br />';
				echo (!empty($context['latest_post']) ? $txt['latest_post'] . ': <strong>&quot;' . $context['latest_post']['link'] . '&quot;</strong>  ( ' . $context['latest_post']['time'] . ' )<br />' : '');
				echo '<a href="', $scripturl, '?action=recent">', $txt['recent_view'], '</a>';
			}
			else {
				echo '<br />';
			}
			echo $context['show_stats'] ? '<br /><a href="' . $scripturl . '?action=stats">' . $txt['more_stats'] . '</a>' : '';
			echo '</p>';
	}
