...
function createPost(&$msgOptions, &$topicOptions, &$posterOptions)
{
	...
	$msgOptions['hiddenOption'] = empty($msgOptions['hiddenOption']) ? 0 : (int)$msgOptions['hiddenOption'];
	$msgOptions['hiddenValue'] = empty($msgOptions['hiddenValue']) ? 0 : (int)$msgOptions['hiddenValue'];
	...
	$smcFunc['db_insert']('',
		...
		array(
			...
			'smileys_enabled' => 'int', 'modified_name' => 'string', 'icon' => 'string-16', 'approved' => 'int',
                        'hiddenOption' => 'int', 'hiddenValue' => 'int', 'hiddenInfo' => 'string-65534',
		),
		array(
