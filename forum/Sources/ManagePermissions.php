	...
	*/
	$permissionList = array(
		...
		'board' => array(
			...
			'hide_post' => array(true, 'post', 'modify', 'moderate'),
			// 'view_hidden_post' => array(false, 'post', 'modify', 'moderate'),
			// 'view_hidden_msg' => array(false, 'post', 'modify', 'moderate'),
			'view_hidden_post' => array(true, 'post', 'modify', 'moderate'),
			'view_hidden_msg' => array(true, 'post', 'modify', 'moderate'),
