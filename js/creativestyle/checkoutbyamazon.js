...
CheckoutByAmazon.prototype = {
    ...
    reloadProgressBlock: function() {
        if (!this.overlay) new Ajax.Updater('checkout-progress-wrapper', this.urls.progress, {method: 'get', evalScripts: true, onFailure: this.ajaxFailure.bind(this)});
    },
    ...
    gotoSection: function(section) {
        ...
        if (Modalbox != 'undefined') Modalbox.resizeToContent();
    },
